...
class NeuralNetMLP(object):
    ...
    def fit(self, X, y, print_progress=False):
        ...
        for i in range(self.epochs):
            ...
            for idx in mini:
                # propagacja jednokierunkowa w przód
                a1, z2, a2, z3, a3, z4, a4 = self._feedforward(X_data[idx], self.w1, self.w2, self.w3)
                cost_tot = self._get_cost(y_enc=y_enc[:, idx], output=a4, w1=self.w1, w2=self.w2, w3=self.w3)
    ...
    def _add_bias_unit(self, X, how='column'):
        # wypełnia pierwszą kolumnę/wiersz jedynkami, co pozwala nam wpływać na wynik oraz rozszerzać punkt decyzyjny
        # funkcji sigmoidalnej, zachowuje się podobnie jak stała w y=ax+b, pozwala lepiej dopasować przewidywania
        if how == 'column':
            ...
            raise AttributeError('Varaible "how" should be either "row" or "column"')
        return X_new
